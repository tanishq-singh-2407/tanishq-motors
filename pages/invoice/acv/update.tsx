...
const Update: NextPage<{ user: user, invoiceData: Invoice }> = ({ user, invoiceData }) => {
            ...
            <main className='h-full w-full bg-slate-100'>
                {
                    isFought || invoiceData !== undefined ?
                        <InvoiceRes invoice={invoiceData !== undefined ? invoiceData : invoice!} operation='update' setIsFought={setIsFought} /> :
